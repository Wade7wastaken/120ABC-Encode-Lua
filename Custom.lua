...
---@param func function
---@param unregister boolean
function emu.atinterval(func, unregister) end

---Registers a function to be run when a savestate is loaded
---@param func function
---@param unregister boolean
function emu.atloadstate(func, unregister) end

---Registers a function to be run when a savestate is saved
---@param func function
---@param unregister boolean
function emu.atsavestate(func, unregister) end

---Registers a function to be run when the emulator is reset
---@param func function
---@param unregister boolean
function emu.atreset(func, unregister) end
